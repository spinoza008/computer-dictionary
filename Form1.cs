...
namespace computer_dictionary
{
    public partial class Form1 : Form
    {
        ...
        // a variable whose values is set to true if a new record is being genereated. it is used to determine how to repond to user clicking of the cancel menu item.
        bool isNew;
        // shows all store data from foldoc in the headword
        ...
        // while editing whats has to show and whats not 
        ...
        // while searching what has to show and whats not
